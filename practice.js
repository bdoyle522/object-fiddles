...
function MakeCard(number,exp,back){
...
var num = 232323232323;
var exp = '07/17';
var back = 098;

var newCard = MakeCard(num,exp,back);
console.log(newCard);
...
function bindCard(person,creditcard){
  var binded = new Object();
  binded.card = creditcard;
  binded.person = person;
  return binded;
}
